...
{{- printf "%s-%s" "ref-efs-gke" .Release.Name | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- printf "%s-%s-%s" "ref-gke" .Release.Name "pv" | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- printf "%s-%s-%s" "ref-gke" .Release.Name "pvc" | trunc 63 | trimSuffix "-" }}
{{- end }}
