...
| `image.tag`        | the regional-addressing container image version tag | `2.0.1`                       |
...
| `global.addressingImage.tag`                      | the addressing-service container image version tag                                                                                                                                                                                 | `2.0.1`                        |
...
| `global.expressEngineImage.tag`                   | the addressing-service container image version tag                                                                                                                                                                                 | `2.0.1`                        |
...
| `global.expressEngineDataRestoreImage.tag`        | the addressing-service container image version tag                                                                                                                                                                                 | `2.0.1`                        |
