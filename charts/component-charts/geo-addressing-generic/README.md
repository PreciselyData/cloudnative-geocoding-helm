...
| `image.tag`        | the regional-addressing container image version tag | `2.0.0`                       |
...
| `global.addressingImage.tag`                      | the addressing-service container image version tag                                                                                                                                                                                 | `2.0.0`                        |
...
| `global.expressEngineImage.tag`                   | the addressing-service container image version tag                                                                                                                                                                                 | `2.0.0`                        |
...
| `global.expressEngineDataRestoreImage.tag`        | the addressing-service container image version tag                                                                                                                                                                                 | `2.0.0`                        |
