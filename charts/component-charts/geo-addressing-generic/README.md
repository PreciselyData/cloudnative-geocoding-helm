...
| `image.tag`        | the regional-addressing container image version tag | `2.0.2`                       |
...
| `global.addressingImage.tag`                      | the addressing-service container image version tag                                                                                                                                                                                 | `2.0.2`                        |
...
| `global.expressEngineImage.tag`                   | the addressing-service container image version tag                                                                                                                                                                                 | `2.0.2`                        |
...
| `global.expressEngineDataRestoreImage.tag`        | the addressing-service container image version tag                                                                                                                                                                                 | `2.0.2`                        |
