...
*/}}
{{- define "autocomplete-svc.fullname" -}}
{{- $top := index . 0 -}}
{{- $var := index . 1 -}}
...
Common labels
*/}}
{{- define "autocomplete-svc.labels" -}}
{{- $top := index . 0 -}}
{{- $var := index . 1 -}}
helm.sh/chart: {{ include "autocomplete-svc.chart" .}}
{{ include "autocomplete-svc.selectorLabels" . }}
...
Selector labels
*/}}
{{- define "autocomplete-svc.selectorLabels" -}}
{{- $top := index . 0 -}}
{{- $var := index . 1 -}}
app.kubernetes.io/name: {{ include "autocomplete-svc.name" . }}
...
*/}}
{{- define "autocomplete-svc.serviceAccountName" -}}
{{- $top := index . 0 -}}
{{- $var := index . 1 -}}
{{- if $top.Values.serviceAccount.create }}
{{- default (include "autocomplete-svc.fullname" .) $top.Values.serviceAccount.name }}
{{- else }}
...
volumeMounts
*/}}
{{- define "autocomplete-svc.volumeMounts" -}}
