...
docker tag regional-addressing-service:latest <your-container-registry-name>.azurecr.io/regional-addressing-service:2.0.1
docker push <your-container-registry-name>.azurecr.io/regional-addressing-service:2.0.1
```
